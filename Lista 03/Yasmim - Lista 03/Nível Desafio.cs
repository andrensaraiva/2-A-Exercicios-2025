...
if (tunel == 1)
{
    ...
    string explorar = Console.ReadLine().ToLower();
    if (explorar == "sim")
    {
...
else if (tunel == 2)
{
    ...
    string extrair = Console.ReadLine().ToLower();
    if (extrair == "sim")
    {
