...
switch (escolhaPocao)
{
    case 1:
        ouro -= 20;
        Console.WriteLine("Vc comprou a proçao de cura. ouro restante: " + ouro);
        break;
    case 2:
        ouro -= 40;
        Console.WriteLine("Vc comprou a proçao de força. ouro restante: " + ouro);
        break;
    case 3:
        ouro -= 30;
        Console.WriteLine("Vc comprou a proçao de mana. ouro restante: " + ouro);
        break;
    default:
