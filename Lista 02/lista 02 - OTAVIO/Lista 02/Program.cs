...
Console.WriteLine("isso é " + (reais / 5) + "dolares");
...
otavio = (Console.ReadLine());
Console.WriteLine("qual seu nivel?");
nivel = int.Parse(Console.ReadLine());
Console.WriteLine("Bem-vindo(a), " + otavio + "! Você começa no nível " + nivel + ".");
...
Console.WriteLine("qual altura do retangulo?");
altura = float.Parse(Console.ReadLine());
Console.WriteLine("qual largura do retangulo?");
largura = float.Parse(Console.ReadLine());
Console.WriteLine("a sua area é " + (altura * largura));
...
Console.WriteLine("um numero inteiro");
...
Console.WriteLine("valor da calca 100 reais, pode me dar o dinheiro?");
...
int xp =11;
int membros = 11;
Console.WriteLine("total de XP ganho pela equip?");
...
Console.WriteLine("total de litros: " + (n23 / n24) + "valor totak da viagem: " + (n25 * (n23 / n24)));
