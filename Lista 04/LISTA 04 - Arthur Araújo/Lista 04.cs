...
{
    Console.WriteLine("consiga a flor");
}

else if (pena == "sim" && escama == "nao" && flor == "sim" && moedas > 499)
{
    Console.WriteLine("consiga a escama");
}
else if (pena == "nao" && escama == "sim" && flor == "sim" && moedas > 499)
{
    Console.WriteLine("consiga a pena");
}
else if (pena == "nao" && escama == "sim" && flor == "sim" && moedas < 499)
{
...
Console.WriteLine(" qual é o melhor? fifa ou PES?");
string fifa = Console.ReadLine();
Console.WriteLine("cr7 ou messi?");
string goat = Console.ReadLine();
Console.WriteLine("Ps5 ou Xbox?");
string pc = Console.ReadLine();

if (fifa == "fifa" && goat == "cr7" && pc == "ps5")
{
    Console.WriteLine("escapou, pode passar");
}
else if (fifa == "pes" && goat == "cr7" && pc == "ps5")
{
    Console.WriteLine("dois enigmas certos, armadilha parcialmente desativada");
}
else if (fifa == "pes" && goat == "messi" && pc == "xbox")
{
    Console.WriteLine("a armadilha não foi desativada :(");
}


Console.WriteLine("Defender a floresta? (sim/nao) (lembre-se, suas ações definem sua reputação)");
string floresta = Console.ReadLine();
Console.WriteLine("Ajudar os mercadores? (sim/nao)");
string mercadores = Console.ReadLine();
Console.WriteLine("Atacar os dois lados? (sim/nao) ");
string lados = Console.ReadLine();


if (floresta == "sim" && mercadores == "sim" && lados == "nao")
{
    Console.WriteLine("boa! reputaçao máxima");
}
else if (floresta == "sim" && mercadores == "sim" && lados == "sim")
{
    Console.WriteLine("sua reputação pode melhorar");
}
else if (floresta == "nao" && mercadores == "nao" && lados == "sim")
{
    Console.WriteLine("sua reputação ta uma bosta");
}
...
if (chave == "sim" && codigo == 1327 && amuleto == "sim")
{
