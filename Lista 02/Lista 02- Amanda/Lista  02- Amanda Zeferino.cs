...
Console.WriteLine("Quantos pirulitos  voce quer?");
int qtdChocolate = int.Parse (Console.ReadLine());

Console.WriteLine("Quantas bolos voce quer?");
...
float subtotalPirulitos = qtdPirulitos * precoPirulitos;
float subtotalBala = qtdBolo * precoBolo;
float  subtotalChiclete = qtdChiclete * precoChiclete;
float total = subtotalPirulitos + subtotalPirulitos + subtotalPirulitos;

Console.WriteLine("Subtotal pirulitos: R$ " + subtotalChocolate);
Console.WriteLine("Subtotal bolos: R$ " + subtotalBala);
Console.WriteLine("Subtotal chicletes: R$ " + subtotalChiclete);
